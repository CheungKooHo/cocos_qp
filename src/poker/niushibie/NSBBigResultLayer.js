 ...
 */
var NSBBigResultLayer = cc.Layer.extend({
    ...
    setLayerWithData:function(){
        ...
        this.label_credit_config.setString(NSBRoomModel.getCreditConfigStr());
    ...
    setInfoData:function(){
        ...
        var jushu = "局数:" + NSBRoomModel.nowBurCount;
        if(NSBRoomModel.totalBurCount < 100){
            jushu += ("/" + NSBRoomModel.totalBurCount);
        }
    ...
    onShare:function(){
        ...
        var obj={};
        var tableId = NSBRoomModel.tableId;
        obj.tableId=tableId;
...
var NSBBigResultItem = cc.Node.extend({
    ctor:function(){
        this._super();
