...
var NSBReplayMgr = {
    ...
    handleReplayData:function(hfData){
        ...
        this.msgArr.push({type:NSBTabelType.CreateTable,data:data});
    ...
    handStepMsg:function(stepsData){
        ...
        for(var idx = 0;idx<stepsData.length;++idx){
            ...
            if(step.action == 0 || step.action == 1){//出牌，不要
                msg.type = NSBTabelType.PlayCard;
                msg.data = {};
                ...
                for (var i = 0; i < table.players.length; ++i) {
                    ...
                    if (p.seat == msg.data.seat) {
                        p.handCardIds = NSBRoomModel.delCardWithArr(p.handCardIds, msg.data.cardIds);
                ...
                msg.type = NSBTabelType.XuanDuZhan;
                msg.data = {};
                ...
                msg.type = NSBTabelType.ChangeTuoGuan;
                msg.data = {};
    ...
    runReplay:function(hfData){
        ...
        if(this.msgArr.length > 0){
            ...
            var ctrLayer = new NSBReplayCtrLayer();
            ...
            NSBRoomModel.init(table);
            layer.handleTableData(NSBTabelType.CreateTable,table);
    ...
    sendTableMsg:function(step){
        ...
        NSBRoomModel.init(table);
        SyEventManager.dispatchTableEvent(NSBTabelType.CreateTable,table);
    },
    ...
    sendOverMsg:function(){
        SyEventManager.dispatchTableEvent(NSBTabelType.OnOver,this.resultData);
    },
