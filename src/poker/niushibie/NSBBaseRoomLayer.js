 ...
 */
var NSBBaseRoomLayer = cc.Layer.extend({
    _dt:0,
    _timedt:0,
    _customEvents:null,
    ctor:function(){
    ...
    addMenuLayer:function(){
        this.menuBtnLayer = new NSBMenuBtnLayer();
    ...
    onClickGpsBtn:function(){
        if(NSBRoomModel.renshu > 2){
            var pop = new GpsPop(NSBRoomModel , NSBRoomModel.renshu);
