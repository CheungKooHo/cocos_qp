 ...
 */
var YYBSSetUpPop = BasePopup.extend({
    ctor: function () {
        this._super("res/sdhSetup.json");
    },

    selfRender: function () {

        this.pz = this.getLocalItem("sy_sdh_pz") || 1;
        this.pm = this.getLocalItem("sy_sdh_pm") || 3;
    ...
    displayPz:function(){
        ...
        cc.sys.localStorage.setItem("sy_sdh_pz",this.pz);
    ...
    displayPm:function(){
        ...
        cc.sys.localStorage.setItem("sy_sdh_pm",this.pm);
        SyEventManager.dispatchEvent("change_sdh_pm",this.pm);
    },
