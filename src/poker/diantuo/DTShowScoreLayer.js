...
var DTShowScoreLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.layerBg = new cc.Scale9Sprite("res/ui/diantuo/score_bg.png");
        ...
        var img = "res/ui/diantuo/score_title_2.png";
        if(this.layerType == 2){
            img = "res/ui/diantuo/score_title_1.png";
        }
    ...
    showCards:function(data){
        ...
        for(var i = 0;i<data.length;++i){
            var itemBg = new cc.Scale9Sprite("res/ui/diantuo/score_di.png");
