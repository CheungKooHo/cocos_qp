 ...
 */
var DTSetUpPop = BasePopup.extend({
    ctor: function () {
    ...
    selfRender: function () {
        ...
        this.pz = this.getLocalItem("sy_dt_pz") || 1;
        this.pm = this.getLocalItem("sy_dt_pm") || 3;
    ...
    displayPz:function(){
        var isLocalCount = this.getLocalItem("tjmj_specialDefault_bg"+MJWanfaType.TJMJ);
        if(MJRoomModel.wanfa == MJWanfaType.TJMJ && (!isLocalCount || isLocalCount != 1)){
            this.pz = 1;
            cc.sys.localStorage.setItem("tjmj_specialDefault_bg"+MJWanfaType.TJMJ,1);
        }
        ...
        cc.sys.localStorage.setItem("sy_dt_pz",this.pz);
    ...
    displayPm:function(){
        ...
        cc.sys.localStorage.setItem("sy_dt_pm",this.pm);
        SyEventManager.dispatchEvent("change_dt_pm",this.pm);
    },
