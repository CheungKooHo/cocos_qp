...
var TCGDSmallResultLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        var bg = new cc.Sprite("res/ui/diantuo/jiugonga1.png");
...
var TCGDSmallResultItem = cc.Node.extend({
    ...
    initNode:function(){
        ...
        for(var i = 0;i<config.length;++i){
            ...
            txt.setPosition(this.itemBg.width - 170,this.itemBg.height/2 + 25);
    ...
    showTgjs:function(){
        var label = UICtor.cLabel("托管解散",28);
        label.setPosition(this.itemBg.width - 320,this.itemBg.height/2);
        label.setColor(cc.color(250,242,102));
