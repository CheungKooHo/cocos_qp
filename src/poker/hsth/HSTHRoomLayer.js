...
var HSTHRoomLayer = HSTHBaseRoomLayer.extend({
    ...
    initLayer:function(){
        ...
        this.label_room_name = new cc.LabelTTF("衡山同花房间名","",24);
        ...
        this.paiZhuoFen.setPosition(cc.winSize.width - 280,cc.winSize.height - 150);
    ...
    setPaiZhuoFen:function(num){
        ...
        for(var i = 0;i<numStr.length;++i){
            ...
            spr.setPosition(140 + 40*i,this.paiZhuoFen.height/2);
            this.paiZhuoFen.addChild(spr);
        }
    },

    addRoomTitle:function(){
        var spr = new cc.Sprite("res/ui/hsth/title_hsth.png");
