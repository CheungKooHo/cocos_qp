...
var QFCardPlayer = cc.Class.extend({
	...
	showHeadFrame:function(){
		if(this._playerVo.frameId > 0){
			...
			if(!this.headFrame){
				...
				this.headFrame.setPosition(cc.p(50,80))
	...
	showIcon:function(){
		...
		var defaultimg = (this._playerVo.sex==1) ? "res/ui/qf/images/default_m.png" : "res/ui/qf/images/default_w.png";
		if(!url)
			url = defaultimg;
	...
	fastChat:function(data){
		...
		if(content){
			...
			sprite = new cc.Scale9Sprite("res/ui/qf/images/img_chat_4.png",null,cc.rect(30,0,10,64));
			if(this.seq==2){
	...
	showStatus:function(status){
		var tMap ={"-1":"res/ui/qf/images/img_35.png","1":"res/ui/qf/images/img_34.png"};
	...
	leaveOrOnLine:function(status){
		if(status == 2){
			...
			var texture = (status==1) ? "res/ui/qf/images/img_dx.png" : "res/ui/qf/images/img_dx.png";
	...
	playerQuanAnimation:function( showOrHide ){
		...
		this.quanAnimation.y = this.iconbg.height * 0.5+15;
