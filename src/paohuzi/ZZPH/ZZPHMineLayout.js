...
setRoot:function(root){
    ...
    getCardOffX:function(){
        ...
        if (PHZSetModel.zpdx == 3 || PHZSetModel.zpdx == 4 ){
            // w = w * (cc.winSize.width/1280 +0.02*(cc.winSize.width/1280));
            w = w * 1.1;
        }
        return w
    },
    ...
    reSetCardPos:function(){
        ...
        //    if(ZZPHMineLayout.isLocked()){
        //        ZZPHMineLayout.unlockCard();
        //    }
        //}
        ...
        for(var i=0;i<result.length;i++){
            ...
            for(var j=0;j<array.length;j++){
                ...
                if(count<nowCards){
                    ...
                    card = new ZZPHCard(PHZAI.getDisplayVo(1,1),array[j]);
