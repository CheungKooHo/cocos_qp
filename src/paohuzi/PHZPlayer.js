...
var PHZPlayer = cc.Class.extend({
    ...
    ctor:function(vo,root,seq){
        ...
        }else if (PHZRoomModel.wanfa == PHZGameTypeModel.CZZP || PHZRoomModel.wanfa == PHZGameTypeModel.WHZ || PHZRoomModel.wanfa == PHZGameTypeModel.LSZP){
            this.label_daniao.setString("飘分中...");
        }else if (PHZRoomModel.wanfa == PHZGameTypeModel.SYBP || PHZRoomModel.wanfa == PHZGameTypeModel.HYSHK){
        ...
        if (PHZRoomModel.wanfa == PHZGameTypeModel.ZHZ || PHZRoomModel.wanfa == PHZGameTypeModel.XXEQS){
        ...
        //cc.log("vo.seat========",JSON.stringify(vo));
    ...
    showChongFenImg:function(type){
        var pngUrl ="res/ui/phz/xxeqs/img_chongfen_"+type+".png";
        this.niao_img.setTexture(pngUrl);
        this.niao_img.visible =true;
    },
    ...
    showDaTuoImg:function(type){
        var pngUrl = "res/ui/phz/phzRoom/img_jiatuo.png";
        if(type != 1){
            pngUrl = "res/ui/phz/phzRoom/img_bujiatuo.png";
        }
    ...
    showHeadFrame:function(){
        ...
        if(!this.Label_coin){
            ...
            this.Label_coin.setPosition(22 - this.creditScore.getAnchorPoint().x*90,5)
