...
var YJGHZRoom = BaseLayer.extend({ //BaseLayer BaseRoom
    ...
    selfRender:function(){
        ...
        this.addCustomEvent("GUO_CHI_CANCEL",this,this.getNewGuoMenzi);
...
/*        var mc = new ChatPop("res/phzChat.json");
    ...
    getNewGuoMenzi:function(event){
        var msg = event.getUserData();

        var data = JSON.parse(msg.strParams[0]);

        var voArray = PHZAI.getVoArray(data);
        var idArray = [];
        var idsArray = [];
        for(var j = 0;j < voArray.length;j++) {
            idArray.push(voArray[j]);
        ...
        PHZRoomModel.hasGuoedByChiData = [];
        PHZRoomModel.updateHasGuoedByChiData(idsArray);
    },
    ...
    displayChiSelect:function(cardsArray,result,needTimes,curTime){
    	...
    	for(var i=0;i<result.length;i++){
            ...
            clickbg.x = initX+i*itemW;
            clickbg.y = bg.height/2-15;
    		innerbg.x = initX+i*itemW;
    ...
    refreshButton:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            var btnDatas = [];
            var textureMap = {
                0:{t:"res/ui/phz/hu.png",v:4},
                1:{t:"res/ui/phz/piao.png",v:2},
                2:{t:"res/ui/phz/liu.png",v:1},
                3:{t:"res/ui/phz/wai.png",v:3},
                4:{t:"res/ui/phz/peng.png",v:5},
                5:{t:"res/ui/phz/chi.png",v:6},
                6:{t:"res/ui/phz/hu.png",v:17},
            };
            ...
            if(btnDatas.length>0 && isShowBtn){
            	...
            	isShowGuo && btnDatas.push({t:"res/ui/phz/guo.png",v:7});
