...
setRoot:function(root){
    ...
    reSetCardPos:function(){
        ...
        //    if(AHPHZMineLayout.isLocked()){
        //        AHPHZMineLayout.unlockCard();
        //    }
        //}
    ...
    saveToLocal:function(cards){
        ...
        //if(PHZRoomModel.wanfa == PHZGameTypeModel.AHPHZ){
            SyEventManager.dispatchEvent(SyEvent.AHPHZ_UPDATE_HUXI,[PHZRoomModel.mySeat,transCards]);
        //}
    },
    ...
    displayCards:function(voArray,sortedData,isReDisPlay){
        ...
        // if(PHZRoomModel.getIs_LHQ_SHK_16()){
        //     this.cardOffY = 96;
        //     this.bgStartY = -10;
        // }
        ...
        for(var i=0;i<result.length;i++){
            ...
            for(var j=0;j<array.length;j++){
                ...
                if(count<nowCards){
                    ...
                    card = new AHPHZCard(PHZAI.getDisplayVo(1,1),array[j]);
    ...
    display:function(voArray,sortedData,isReDisPlay){
        if (PHZRoomModel.wanfa == PHZGameTypeModel.YZCHZ){
             this.displayForYZCHZ(voArray,sortedData,isReDisPlay);
        }else{
            this.displayCards(voArray,sortedData,isReDisPlay);
        }
    },

    displayForYZCHZ:function(voArray,sortedData,isReDisPlay){
        if (PHZSetModel.zpdx == 4){
            this.cardOffY = 87;
            this.bgStartY = -10;
        }else{
        ...
        var winSize = cc.director.getWinSize();
        //var w = PHZSetModel.zpdx == 1 ? 87 : 75; //75
        var w = this.getCardOffXForYZCHZ();
        //var offheight = 78; //68
        var initX = (winSize.width - w*result.length)/2;
        var count = 0;
        this.coords.length=0;
        ...
        for(var i=0;i<result.length;i++){
            ...
            for(var j=0;j<array.length;j++){
                ...
                if(count<nowCards){
                    ...
                    card = new YZCHZCard(PHZAI.getDisplayVo(1,1),array[j]);
                    this.root.addChild(card,zorder);
                }
