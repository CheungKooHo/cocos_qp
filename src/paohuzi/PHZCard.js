...
var PHZCard = ccui.Widget.extend({
            ...
            if(isMyTurn && PHZRoomModel.selfAct.length==0){
                if (PHZRoomModel.getTouchCard() != this._cardVo.v){
                    ...
                    if(PHZRoomModel.wanfa == PHZGameTypeModel.WHZ || PHZRoomModel.wanfa == PHZGameTypeModel.LDS
                        ...
                        || PHZRoomModel.wanfa == PHZGameTypeModel.YJGHZ || PHZRoomModel.wanfa == PHZGameTypeModel.NXGHZ){
    ...
    diplay:function(action){
        ...
        if(PHZRoomModel.wanfa == PHZGameTypeModel.WHZ || PHZRoomModel.wanfa == PHZGameTypeModel.YJGHZ || PHZRoomModel.wanfa == PHZGameTypeModel.NXGHZ){
            same = 0;
        }
        ...
        if((PHZRoomModel.wanfa == PHZGameTypeModel.YJGHZ||PHZRoomModel.wanfa == PHZGameTypeModel.NXGHZ) && same == 1){
            same = 0;
            this.setGrayCanMove();
        }
        ...
        if(same==1&&direct==1&&place==1){//大于等于3个一样的 加一层遮罩
            if(PHZRoomModel.wanfa != PHZGameTypeModel.LDS
                && PHZRoomModel.wanfa != PHZGameTypeModel.YZCHZ
                && PHZRoomModel.wanfa != PHZGameTypeModel.XXEQS){//落地扫不让加置灰，说是看着不爽，我了个去
                bgImg.setColor(cc.color(175,175,175));
            }
        }
