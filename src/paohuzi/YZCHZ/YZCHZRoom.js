...
var YZCHZRoom = BaseLayer.extend({ //BaseLayer BaseRoom
    ...
    selfRender:function(){
        ...
        if(!SdkUtil.isReview()){
            ...
            var recordBtn = this.recordBtn = new RecordAudioButton(this.yuyin,this.progCycle,"res/ui/yzchz/game_yuying.png","res/ui/yzchz/game_yuying.png");
        ...
        if (PHZRoomModel.renshu == 2){
            this.getWidget("oPanel1").x =  (cc.winSize.width - 1280)/2 + this.getWidget("oPanel1").x - disXForIphoneX;
            this.getWidget("oPanel2").x =  (1280 - cc.winSize.width)/2 + this.getWidget("oPanel2").x + disXForIphoneX;
            this.getWidget("sPanel2").x = this.getWidget("mPanel2").x = this.getWidget("sPanel1").x = this.getWidget("mPanel1").x = 
            (1280 -cc.winSize.width)/2 + disXForIphoneX;
            ...
            (1280 -cc.winSize.width)/2 + disXForIphoneX;
            this.getWidget("oPanel3").x =  (1280 - cc.winSize.width)/2 + this.getWidget("oPanel3").x + disXForIphoneX;

            this.getWidget("oPanel2").x =  (cc.winSize.width - 1280)/2 + this.getWidget("oPanel2").x - disXForIphoneX;
            this.getWidget("sPanel2").x = this.getWidget("mPanel2").x = (cc.winSize.width - 1280)/2 + this.getWidget("mPanel2").x - disXForIphoneX;
...
/*        var mc = new ChatPop("res/phzChat.json");
    ...
    onSetUp:function(){
        // var self = this;
        // var ids = [1,1,1]
        // PHZRoomEffects.chiAnimate(ids,this.root,2,function(){
        //     //只有局数是当前局的时候， 才更新最终显示
        //     self.layouts[2].chiPai(ids,2,2,false);
        //     self.finishLetOut(2,2,ids);
        // },2,1);
    ...
    initData:function(){
        ...
        for(var i=0;i<players.length;i++){
            ...
            if(PHZRoomModel.getIsSwitchCoin()){
                this._players[p.seat].Label_coin.x = this._players[p.seat].creditScore.x - 35
            }
        ...
        if (PHZRoomModel.is4Ren()) {
            ...
            if (paiDun == 0 && remain > 0) {
                for (var i=0;i<remain;i++) {
                    var dun = new cc.Sprite("res/ui/yzchz/fapai_pai.png");
    ...
    displayChiSelect:function(cardsArray,result,needTimes,curTime){
        ...
        var initX = result.length == 1?15:(bg.width-65*result.length-(result.length-1)*5)/2;
    ...
    refreshButton:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            var btnDatas = [];
            var textureMap = {
                0:{t:"res/ui/yzchz/hu.png",v:1},2:{t:"res/ui/phz/wai.png",v:3},3:{t:"res/ui/phz/liu.png",v:4},1:{t:"res/ui/yzchz/peng.png",v:2},
                4:{t:"res/ui/yzchz/chi.png",v:6},5:{t:"res/ui/phz/pao.png",v:7}};

            if(PHZRoomModel.wanfa == PHZGameTypeModel.LDS || PHZRoomModel.wanfa == PHZGameTypeModel.YZCHZ){
                textureMap[7] = {t:"res/ui/yzchz/wangdiao.png",v:15};
                textureMap[8] = {t:"res/ui/yzchz/wangchuang.png",v:16};
                textureMap[9] = {t:"res/ui/yzchz/wangzha.png",v:19};
                textureMap[10] = {t:"res/ui/yzchz/wangzha.png",v:20};
                textureMap[11] = {t:"res/ui/yzchz/wangchuang.png",v:18};
                textureMap[12] = {t:"res/ui/yzchz/wangdiao.png",v:17};
            }
            ...
            if(btnDatas.length>0 && isShowBtn){
                ...
                isShowGuo && btnDatas.push({t:"res/ui/yzchz/guo.png",v:5});
                var w = 150;//118
                var g = 20;
    ...
    onLetOutPai:function(message){
        ...
        if(PHZRoomModel.wanfa == PHZGameTypeModel.LDS || PHZRoomModel.wanfa == PHZGameTypeModel.YZCHZ){//落地扫王闯之类的胡牌操作特殊处理下
    ...
    showJianTou:function(seat,isTing){
        ...
        if(seat > 0){
            ...
            if(PHZRoomModel.renshu==4){
                ...
                coords = {1:{x:270 + (1280-cc.winSize.width)/2,y:350},2:{x:900 + (cc.winSize.width - 1280)/2,y:600},3:{x:270 + (1280-cc.winSize.width)/2,y:600}};
            }else{
                coords = {1:{x:270 + (1280-cc.winSize.width)/2,y:350},2:{x:270 + (1280-cc.winSize.width)/2,y:600}};
            }
