...
var CSMahjong = ccui.Widget.extend({
    ...
    onTouchHandler:function(obj,type){
        ...
        if(MJRoomModel.wanfa == MJWanfaType.KWMJ && MJRoomModel.mj_xianjia_oprete){
            return false;
        }
        ...
        if(MJRoomModel.selfAct.length>0){
            ...
            }else if(MJRoomModel.wanfa == MJWanfaType.TJMJ){//先不锁
                var hasOption = false;
                for(var i = 0;i<MJRoomModel.selfAct.length;++i){
                    if(MJRoomModel.selfAct[i] == 1){
                        hasOption = true;
        ...
        if((MJRoomModel.banker == MJRoomModel.mySeat) && !MJRoomModel.csmjIsOptXiaoHu && (MJRoomModel.wanfa == MJWanfaType.CSMJ || MJRoomModel.wanfa == MJWanfaType.TJMJ)){
            return false;
        }
        if(this._cardVo.openTing == 1 && MJRoomModel.wanfa == MJWanfaType.TJMJ){
            return false;
        }
        ...
        if(this._cardVo.wang == 1 && MJRoomModel.wanfa == MJWanfaType.NYMJ && MJRoomModel.intParams[13] == 0 && !MJRoomModel.nymjTwoMJ){//宁远麻将王牌不能出
            return false;
        }
        ...
        if(type == ccui.Widget.TOUCH_BEGAN){
            if(!this.selected){
                ...
                if(MJRoomModel.isTingSelecting){
                    ...
                    if(this._cardVo.wang == 1 && (MJRoomModel.wanfa == MJWanfaType.TCMJ ||MJRoomModel.wanfa == MJWanfaType.TJMJ || MJRoomModel.wanfa == MJWanfaType.GDCSMJ)){
                    ...
                    }else if(this._cardVo && this._cardVo.i == 201 && (MJRoomModel.wanfa != MJWanfaType.TJMJ && MJRoomModel.wanfa != MJWanfaType.GDCSMJ && MJRoomModel.wanfa != MJWanfaType.NYMJ)) {
                        ...
                        self.x = self.initX;
                        self.y = self.initY;
                    }else if(this._cardVo.wang == 1 && MJRoomModel.wanfa == MJWanfaType.NYMJ && MJRoomModel.intParams[13] == 1) {
                        AlertPop.show("万能牌，确定要出吗？", function () {
                            self.onChuMahjong();
                        }, function () {
                            self.selected = false;
        ...
        if (this._cardVo.wang == 1){
            ...
            if (direct == 1){
                if(MJRoomModel.wanfa == MJWanfaType.TJMJ){
                    var wang_logo = new cc.Sprite("res/ui/mj/tjmjRoom/tjmjWang.png");
                    wang_logo.setPosition(15,112);
    ...
    displayTingArrows:function(tingList,huCardNum){
        if(MJRoomModel.wanfa == MJWanfaType.TJMJ){
            if(!this.getChildByTag(1009)){
                var png = "res/ui/mj/tjmjRoom/ting.png";
                var arrowsImg = new cc.Sprite(png);
                arrowsImg.setPosition(74,112);
