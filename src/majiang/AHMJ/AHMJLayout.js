...
var AHMJLayout = cc.Class.extend({
    ...
    refreshP1:function(data){
        ...
        }else if(MJRoomModel.wanfa == MJWanfaType.TCPFMJ){
            if(MJRoomModel.ahmj_wangID > 0){
                var cardVo = MJAI.getMJDef(MJRoomModel.ahmj_wangID);
        ...
        var _wangVo = MJAI.getMJDef(MJRoomModel.ahmj_wangID)
        for(var i=0;i<data.length;i++){
            if (MJRoomModel.wanfa == MJWanfaType.AHMJ || MJRoomModel.wanfa == MJWanfaType.KWMJ){
                if (MJRoomModel.ahmj_wangID && MJRoomModel.ahmj_wangID != -1){
                    ...
                    }else if (MJRoomModel.wanfa == MJWanfaType.KWMJ && MJRoomModel.intParams[4] == 0 && data[i].t == _wangVo.t && data[i].n == _wangVo.n){
                        data[i].zhengwang = 1;
                    }
                }
            }
    ...
    refreshP2:function(data){
        ...
        if(MJRoomModel.wanfa == MJWanfaType.TCPFMJ && MJRoomModel.intParams[4] == 1){
            for (var i = 0; i < data.length; i++) {
        ...
        for(var i=0;i<teamData.length;i++) {
            ...
            if (MJWanfaType.CXMJ == MJRoomModel.wanfa && innerAction == MJAction.PENG && this.direct == 1){
