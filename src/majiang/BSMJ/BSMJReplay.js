...
var BSMJReplay = BaseLayer.extend({
    ...
    initData:function(flag){
        ...
        var resultPlayers = MJReplayModel.closingMsg.closingPlayers;
    ...
    playing:function(){
        ...
        if(step){
            ...
            if(MJReplayModel.step==(MJReplayModel.steps.length-1)){
                var mc = new BSMJSmallResultPop(MJReplayModel.closingMsg,true);
                PopupManager.addPopup(mc);
            }
        }
    },
