 ...
 */
var NXMahjong = ccui.Widget.extend({
    ...
    onTouchHandler:function(obj,type){
        ...
        if((MJRoomModel.banker == MJRoomModel.mySeat) && !MJRoomModel.csmjIsOptXiaoHu && MJRoomModel.wanfa == MJWanfaType.NXMJ){
            return false;
        }
        ...
        if(type == ccui.Widget.TOUCH_BEGAN){
            if(!this.selected){
                ...
                if(MJRoomModel.isTingSelecting){
                    ...
                    if(this._cardVo.wang == 1 && (MJRoomModel.wanfa == MJWanfaType.TJMJ || MJRoomModel.wanfa == MJWanfaType.GDCSMJ)){
                    ...
                    }else if(this._cardVo && this._cardVo.i == 201 && (MJRoomModel.wanfa != MJWanfaType.TJMJ && MJRoomModel.wanfa != MJWanfaType.GDCSMJ)){
